...
public class HelloWorldClientTls {
    ...
    static String clientCertPath = Paths.get("src", "main", "resources", "sslConfig", "server.crt").toString();
    static String clientKey =  Paths.get("src", "main", "resources", "sslConfig", "server.pem").toString();
    static String caCert =  Paths.get("src", "main", "resources", "sslConfig", "ca.crt").toString();
...
//                break;
//            case 3:
                client = new HelloWorldClientTls("localhost", 20000,
                        buildSslContext(caCert, clientCertPath, clientKey));
//                break;
//            default:
//                client = new HelloWorldClientTls(args[0], Integer.parseInt(args[1]),
