...
print_headers() {
    local currOut=${1}
    echo "valid,ts,id,type,workers,tmo,txSize,txInBlock,txTotal,duration,tps,nob,bps,avgTxInBlock,opt,opRate,pos,posRate,neg,negRate,avgNegTime,ATDT,APDT,T,P,syncEvents" >> $currOut/servers/summery.csv
